...
ENABLE_WEB_SOURCE = os.getenv("ENABLE_WEB_SOURCE", "false").lower()
ENABLE_PDF_SOURCE = os.getenv("ENABLE_PDF_SOURCE", "false").lower()
ENABLE_EXCEL_SOURCE = os.getenv("ENABLE_EXCEL_SOURCE", "false").lower()
ENABLE_DOC_SOURCE = os.getenv("ENABLE_DOC_SOURCE", "false").lower()
